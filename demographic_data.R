...
census = left_join(census,census_geography[c("area","fips")],by="fips")
census = left_join(census,sahie[c("perc_insured","perc_poverty","fips")],by="fips")
census = left_join(census,demography[c("over_65","fips")],by="fips")
